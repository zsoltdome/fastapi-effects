...
from fastapi_effects.core.protocols import HandlerSessionProvider
from fastapi_effects.core.retry import RetryPolicy
from fastapi_effects.core.routing import RouteRegistry, RouteSpecification
...
class PostgresBoundaryDriver:
    ...
    def __init__(
        ...
        *,
        ...
        self._delegation_issuer = DelegationIssuer(
            issuer="fastapi_effects_conformance",
    ...
    def manifest(self) -> CapabilityManifest:
        return CapabilityManifest(
            adapter_name="fastapi_effects_postgresql-core",
            adapter_version=__version__,
            implementation="fastapi_effects.testing.postgres_driver.PostgresBoundaryDriver",
