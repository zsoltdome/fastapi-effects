...
class OptionalDependencyError(MergenConfigurationError, ImportError):
    ...
    error_code = "mergen.optional_dependency"
    ...
    def __init__(
        ...
        *,
        ...
        if retry_after is not None and retry_after < timedelta(0):
            raise MergenConfigurationError("Delivery Retry-After cannot be negative.")
...
class PermanentDeliveryError(MergenError):
    ...
    error_code = "mergen.delivery_permanent"
...
class DedupeConflict(MergenError):
    ...
    error_code = "mergen.dedupe_conflict"
...
class OptimisticConflict(MergenError):
    """Report a stale mutable-control revision without exposing protected data."""

    error_code = "mergen.optimistic_conflict"
...
class SchemaRevisionMismatch(MergenError):
    ...
    error_code = "mergen.schema_revision_mismatch"
