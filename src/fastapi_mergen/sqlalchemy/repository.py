...
from fastapi_mergen.errors import DedupeConflict, MergenConfigurationError
...
class RuntimeRepository:
        ...
        *,
        ...
        if inserted is None:
            if dedupe_identity is None:
                raise MergenConfigurationError("Event insertion returned no durable record.")
    ...
    async def _event_for_dedupe(
        ...
        *,
        ...
        if row is None:
            raise MergenConfigurationError("Concurrent dedupe resolution produced no event.")
        return row
