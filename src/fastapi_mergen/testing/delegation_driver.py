...
from fastapi_mergen.delegation.bridge import DelegationBridge, TrustedCallerMetadata
...
class RealDelegationBoundaryDriver:
    ...
    def manifest(self) -> CapabilityManifest:
        return CapabilityManifest(
            adapter_name="fastapi-mergen-delegation",
            adapter_version="0.11.0a1",
            implementation=(
                "fastapi_mergen.testing.delegation_driver.RealDelegationBoundaryDriver"
            ),
    ...
    async def mint_delegation(
        ...
        *,
        ...
        return request.headers["Mergen-Delegation"]
