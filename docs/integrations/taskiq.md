...
Certified range: Taskiq `>=0.12.5,<0.13`, Python 3.11–3.14, PostgreSQL 16–18, and
the `asyncpg` driver. Broker plugins have their own compatibility and durability
requirements and are selected by the host application.
