...
- the outer FastAPI Effects UoW commits the invoice, event, and frozen delivery together;
...
`FASTAPI_EFFECTS_TEST_ADMIN_DSN` like the rest of the PostgreSQL integration suite.
