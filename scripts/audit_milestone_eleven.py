...
REQUIRED = (
    ...
    "src/fastapi_effects/idempotency/models.py",
    "src/fastapi_effects/idempotency/fingerprint.py",
    "src/fastapi_effects/idempotency/request.py",
    "src/fastapi_effects/idempotency/store.py",
    "src/fastapi_effects/idempotency/command.py",
    "src/fastapi_effects/idempotency/responses.py",
    "src/fastapi_effects/postgres/command_schema.py",
    "src/fastapi_effects/postgres/migrations/versions/0004_commands.py",
    "src/fastapi_effects/testing/idempotency_driver.py",
